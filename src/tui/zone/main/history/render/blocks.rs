...
pub(crate) fn render_group(
    ...
    let mut lines = chat::single_node(group, t, show_reasoning, tools_expanded, width);
...
mod tests {
    ...
    fn block_rows_fit_the_width_exactly() {
        ...
        let b = render_group(&es, Range { start: 0, end: 1 }, &t(), true, false, 20);
    ...
    fn long_user_text_wraps_and_keeps_every_char() {
        ...
        let b = render_group(&es, Range { start: 0, end: 1 }, &t(), true, false, 10);
        let joined: String = b
            .rows
            .iter()
